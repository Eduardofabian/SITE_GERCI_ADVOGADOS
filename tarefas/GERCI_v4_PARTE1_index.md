# TAREFA — Gérci v4 · Parte 1 de 3 · index.php
...
## CONTEXTO
Site institucional. Esta parte cria apenas o index.php completo.
Paleta: Preto #0F0F10 · Azul #1A4B8C · Dourado #C9A55A
Stack: PHP + GSAP (CDN) + CSS puro + JS vanilla
Fotos disponíveis: images/equipe/gerci.jpg · images/equipe/leonardo.jpg
...
## DEPENDÊNCIAS (criar antes de testar)
- css/style.css (Parte 2)
- js/main.js (Parte 3)
- images/logo/Logo_Antiga.png
- images/equipe/gerci.jpg
- images/equipe/leonardo.jpg
...
<div class="wa-wrap" id="waWrap">
  <div class="wa-form" id="waForm">
    <div class="wa-form-header">
      <div class="wa-avatar"><img src="images/logo/Logo_Antiga.png" alt="Gérci Libero"></div>
...
```
Arquivo criado: D:\xamp\htdocs\gerci\Site\index.php
Próximo passo: executar Parte 2 (style.css) e Parte 3 (main.js)
```
